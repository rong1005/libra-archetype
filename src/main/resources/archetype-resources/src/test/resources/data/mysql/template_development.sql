...
CREATE TABLE `${tablePrefix}department` (
  ...
  CONSTRAINT `FK_id9eubd0ikv9whim66pe7380b` FOREIGN KEY (`higher_department_id`) REFERENCES `${tablePrefix}department` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of ${tablePrefix}department
-- ----------------------------
INSERT INTO `${tablePrefix}department` VALUES ('1', null, null, '公司总部', '羽科技有限公司', null);
INSERT INTO `${tablePrefix}department` VALUES ('2', null, null, '搞软件开发的', '软件中心', '1');
INSERT INTO `${tablePrefix}department` VALUES ('3', null, null, '负责发钱的！', '财务中心', '1');
INSERT INTO `${tablePrefix}department` VALUES ('4', null, null, 'JAVA开发', 'JAVA开发一组', '2');
INSERT INTO `${tablePrefix}department` VALUES ('5', null, null, '测试', '测试组', '2');
INSERT INTO `${tablePrefix}department` VALUES ('6', null, null, 'JAVA开发', 'JAVA开发二组', '2');
...
CREATE TABLE `${tablePrefix}project` (
  ...
  CONSTRAINT `FK_muw3a8w31hw00a06fhp91xy52` FOREIGN KEY (`director`) REFERENCES `${tablePrefix}user` (`id`)
...
CREATE TABLE `${tablePrefix}task` (
  ...
  CONSTRAINT `FK_elk6mlelf430j9ip1dka77avv` FOREIGN KEY (`user_id`) REFERENCES `${tablePrefix}user` (`id`)
...
INSERT INTO `${tablePrefix}user` VALUES ('2', 'user@163.com', 'user', '成员一', '2488aa0c31c624687bd9928e0a5d29e7d1ed520b', '2012-06-04 02:00:00', 'user', '6d65d24122c30500', '2014-04-27 16:45:52', '2014-04-27 16:45:54', 'avatar1.jpg');
