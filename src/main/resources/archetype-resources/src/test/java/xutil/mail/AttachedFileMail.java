...
public static void main(String[] args) throws Exception{ 
    ...
    FileSystemResource file = new FileSystemResource(new File("C:/Users/Public/Pictures/Sample Pictures/dt.jpg")); 
    //这里的方法调用和插入图片是不同的。 
    messageHelper.addAttachment("灯塔.jpg",file); 
