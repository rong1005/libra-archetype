...
<body>
			...
			<div class="row">
				<div id="content" class="col-lg-12">
						...
						<div class="col-sm-12">
							<div class="page-header">
								...
								<ul class="breadcrumb">
									...
									<li>
										<a href="${symbol_dollar}{ctx}/project">项目列表</a>
									</li>
									<li>创建项目</li>
								</ul>
								<!-- /BREADCRUMBS -->
					...
					<div class="box border primary">
						...
						<div class="box-body">
							<form id="inputForm" class="form-horizontal" action="${symbol_dollar}{ctx}/project/${symbol_dollar}{action}" method="post">
								<input type="hidden" name="id" value="${symbol_dollar}{project.id}"/>
								
								<div class="form-group">
									<label class="col-sm-2 control-label">项目名称</label>
									<div class="col-sm-10">
										<input type="text" id="project_name" name="name" value="${symbol_dollar}{project.name}" class="form-control" placeholder="项目名称"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea rows="3" cols="5" id="description" name="description" class="autosize countable form-control" placeholder="项目描述" data-limit="100">${symbol_dollar}{project.description}</textarea>
	...
	<script>
		jQuery(document).ready(function() {
			...
			${symbol_dollar}("#project_name").focus();
			//表单校验.
			${symbol_dollar}("#inputForm").validate({
