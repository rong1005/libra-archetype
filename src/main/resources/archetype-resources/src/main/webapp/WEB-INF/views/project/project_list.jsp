								...
								<div class="box-body">
									<form class="form-inline" action="#">
										<div class="form-group">
											<input type="text" name="search_LIKE_name" class="form-control" value="${symbol_dollar}{param.search_LIKE_name}" placeholder="项目名称" />
										</div>
									...
									<table  class="table table-striped table-bordered table-hover">
										...
										<tbody>
										<c:forEach items="${symbol_dollar}{projects.content}" var="project">
											<tr>
												<td>${symbol_dollar}{project.name}</td>
												<td>${symbol_dollar}{project.director.name}</td>
												<td><a href="${symbol_dollar}{ctx}/project/update/${symbol_dollar}{project.id}">修改</a> / <a href="${symbol_dollar}{ctx}/project/delete/${symbol_dollar}{project.id}" onclick="return confirm('是否删除该项目？')" >删除</a></td>
											</tr>
										</c:forEach>
										</tbody>
									</table>
									<div class="row">
										<div class="col-sm-12">
											<div class="pull-right">
												<tags:pagination page="${symbol_dollar}{projects}" paginationSize="5"/>
											</div>
											
											<div class="pull-left">
												<a class="btn btn-info" href="${symbol_dollar}{ctx}/project/create">创建项目</a>
											</div>
										</div>
									</div>
								</div>
