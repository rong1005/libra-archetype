...
<head>
	...
	<link rel="stylesheet" type="text/css"  href="${symbol_dollar}{ctx}/static/css/themes/default.css" id="skin-switcher" >
	<link rel="stylesheet" type="text/css"  href="${symbol_dollar}{ctx}/static/css/responsive.css" >
