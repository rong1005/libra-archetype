			...
			<div class="row">
				<div id="content" class="col-lg-12">
						...
						<div class="col-sm-12">
							<div class="page-header">
								...
								<ul class="breadcrumb">
									...
									<li>
										<a href="${symbol_dollar}{ctx}/task">任务列表</a>
									</li>
									<li>创建任务</li>
								</ul>
								<!-- /BREADCRUMBS -->
					...
					<div class="box border primary">
						...
						<div class="box-body">
							<form id="inputForm" class="form-horizontal" action="${symbol_dollar}{ctx}/task/${symbol_dollar}{action}" method="post">
								<input type="hidden" name="id" value="${symbol_dollar}{task.id}"/>
								
								<div class="form-group">
									<label class="col-sm-2 control-label">任务名称</label>
									<div class="col-sm-10">
										<input type="text" id="task_title" name="title" value="${symbol_dollar}{task.title}" class="form-control" placeholder="任务名称"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea rows="3" cols="5" id="description" name="description" class="autosize countable form-control" data-limit="100">${symbol_dollar}{task.description}</textarea>
