								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<%-- <select id="department_higher"  name="higherDepartment.id" class="form-control">
											...
											<c:forEach var="item" items="${symbol_dollar}{departmentList}">
												<option value="${symbol_dollar}{item.id }" <c:if test="${symbol_dollar}{item.id eq department.higherDepartment.id }">selected="selected"</c:if>>${symbol_dollar}{item.name }</option>
											</c:forEach>
										</select> --%>
