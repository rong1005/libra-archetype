							...
							<div class="box border primary">
								...
								<div class="box-body">
									...
									<table  class="table table-striped table-bordered table-hover">
										...
										<tbody>
										<c:forEach items="${symbol_dollar}{sidebars.content}" var="sidebar">
											<tr>
												<td>${symbol_dollar}{sidebar.name}</td>
												<td>${symbol_dollar}{sidebar.code}</td>
												<td>${symbol_dollar}{sidebar.href}</td>
												<td>${symbol_dollar}{sidebar.preSidebar.name}</td>
												<td><a href="${symbol_dollar}{ctx}/sidebar/update/${symbol_dollar}{sidebar.id}">修改</a> / <a href="${symbol_dollar}{ctx}/sidebar/delete/${symbol_dollar}{sidebar.id}" onclick="return confirm('是否删除该菜单？')">删除</a></td>
											</tr>
										</c:forEach>
										</tbody>
									</table>
									<div class="row">
										<div class="col-sm-12">
											<div class="pull-right">
												<tags:pagination page="${symbol_dollar}{sidebars}" paginationSize="5"/>
											</div>
											
											<div class="pull-left">
												<a class="btn btn-info in-loading" href="${symbol_dollar}{ctx}/sidebar/create">创建菜单</a>
											</div>
										</div>
									</div>
								</div>
