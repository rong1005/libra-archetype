								...
								<div class="box-body">
									<form class="form-inline" action="#">
										<div class="form-group">
											<input type="text" name="search_LIKE_title" class="form-control" value="${symbol_dollar}{param.search_LIKE_title}" placeholder="名称" />
										</div>
									...
									<table  class="table table-striped table-bordered table-hover">
										...
										<c:forEach items="${symbol_dollar}{tasks.content}" var="task">
											<tr>
												<td>${symbol_dollar}{task.title}</td>
												<td><a href="${symbol_dollar}{ctx}/task/update/${symbol_dollar}{task.id}">修改</a> / <a href="${symbol_dollar}{ctx}/task/delete/${symbol_dollar}{task.id}" onclick="return confirm('是否删除该任务？')">删除</a></td>
											</tr>
										</c:forEach>
										</tbody>
									</table>
									<div class="row">
										<div class="col-sm-12">
											...
											<div class="pull-left">
												<a class="btn btn-info" href="${symbol_dollar}{ctx}/task/create">创建任务</a>
											</div>
										</div>
									</div>
								</div>
