...
<head>
	...
	<![endif]-->
	<link type="image/x-icon" href="${symbol_dollar}{ctx}/static/img/logo/favicon.ico" rel="shortcut icon">
	...
	<!-- ANIMATE -->
	<link rel="stylesheet" type="text/css" href="${symbol_dollar}{ctx}/static/css/animatecss/animate.min.css" />
	<!-- FONTS 
...
<body class="login">	
				...
				<div class="container">
					<div class="row">
						<div class="col-md-4 col-md-offset-4">
							<div id="logo">
								<a href="index.html"><img src="${symbol_dollar}{ctx}/static/img/logo/logo.png" height="40" alt="logo name" /></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-4 col-md-offset-4">
							<div class="login-box">
								...
								<h5 class="text-success" style="line-height: 40px;"><i class="fa fa-check-square-o"></i> ${symbol_dollar}{message}</h5>
								</c:if>
								</div>
								<form role="form" id="loginForm" action="${symbol_dollar}{ctx}/login" method="post">
								  <div class="form-group">
									<label for="username">手机号 / 账号 / 邮箱</label>
									<i class="fa fa-envelope"></i>
									<input type="text" name="username" class="form-control" id="username" value="${symbol_dollar}{username}" >
								  </div>
								  <div class="form-group"> 
					...
					<div class="row">
						<div class="col-md-4 col-md-offset-4">
							<div class="login-box">
								...
								<form role="form" id="registerForm" action="${symbol_dollar}{ctx}/register" method="post">
								  <div class="form-group">
	...
	<!-- BACKSTRETCH -->
	<script type="text/javascript" src="${symbol_dollar}{ctx}/static/js/backstretch/jquery.backstretch.min.js"></script>
	
	<!-- JQUERY-VALIDATE -->
	<script type="text/javascript" src="${symbol_dollar}{ctx}/static/js/jquery-validate/jquery.validate.min.js"></script>
	<script type="text/javascript" src="${symbol_dollar}{ctx}/static/js/jquery-validate/additional-methods.min.js"></script>
	
	<!-- COOKIE -->
	<script type="text/javascript" src="${symbol_dollar}{ctx}/static/js/jQuery-Cookie/jquery.cookie.min.js"></script>
	
	<script type="text/javascript">
	jQuery(document).ready(
			function() {
				${symbol_dollar}(".uniform").uniform();
				//设置图片轮换.
				${symbol_dollar}("body").backstretch(
						[
						 "${symbol_dollar}{ctx}/static/img/login/2.jpg",
						 "${symbol_dollar}{ctx}/static/img/login/3.jpg",
						 "${symbol_dollar}{ctx}/static/img/login/4.jpg"
						 ], 
						{duration : 3000,fade : 750}
						);
			
				//登录校验.
				${symbol_dollar}("#loginForm").validate({
					errorPlacement: function(error, element) { 
					    ${symbol_dollar}(element).attr("data-content",${symbol_dollar}(error).html());
					    ${symbol_dollar}(element).popover({
					    	placement : 'left',
					    	trigger : 'focus'
					    });
					},
		...
		//清除侧边栏的历史样式Cookie.
		${symbol_dollar}.cookie('mini_sidebar',null); 
	</script>
	<!-- /JAVASCRIPTS -->
</body>
</html>